...
table = dynamodb.Table(os.environ["MUM_TABLE_NAME"])
...
def lambda_handler(event, context):
    """
    Scans DynamoDB for maternal profiles, deduplicates by location,
    ...
    while True:
        for item in items:
            ...
            print(f"[ProfilesToLocationsFn] Queuing location: {loc_key}")
